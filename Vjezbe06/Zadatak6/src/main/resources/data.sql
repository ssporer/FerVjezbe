...
MERGE INTO LIBRARY.BOOK (ID, TITLE, AUTHOR_ID) KEY (ID, TITLE, AUTHOR_ID) VALUES (SELECT TOP(1) ID FROM LIBRARY.BOOK WHERE TITLE = 'The Metamorphosis', 'The Metamorphosis', SELECT ID FROM LIBRARY.AUTHOR WHERE FIRST_NAME = 'Franz' AND LAST_NAME = 'Kafka');
