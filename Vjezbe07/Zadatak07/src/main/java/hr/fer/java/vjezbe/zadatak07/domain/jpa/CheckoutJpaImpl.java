...
import hr.fer.java.vjezbe.zadatak07.domain.jpa.entity.CheckoutEntity;
import hr.fer.java.vjezbe.zadatak07.domain.jpa.repository.BookRepository;
import hr.fer.java.vjezbe.zadatak07.domain.jpa.repository.CheckoutRepository;
import hr.fer.java.vjezbe.zadatak07.domain.jpa.repository.LibrarianRepository;
...
@Repository @Transactional public class CheckoutJpaImpl implements CheckoutDao {
    ...
    @Override public void checkout(CheckoutDto dto) {
        ...
        checkout.setPersonByPersonId(personRepository.findById(dto.getMemberId()).get());
