package hr.fer.java.vjezbe.zadatak7.model;

import hr.fer.java.vjezbe.zadatak7.domain.jpa.entity.*;
import hr.fer.java.vjezbe.zadatak7.service.util.LocalDateTimeUtil;
